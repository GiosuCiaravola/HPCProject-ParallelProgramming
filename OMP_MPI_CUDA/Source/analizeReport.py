...
for path, currentDirectory, files in os.walk("EditDistanceReport/OMP_MPI"):#for each file in the directory Informations, analize them and save the results in the relative path in Results directory
    files = sorted(files)
    for file in files:
